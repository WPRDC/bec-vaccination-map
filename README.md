...
Access to the vaccine has not been equitable since the start of the pandemic, and structural racism is at the root of disparate access. Rather than allocating vaccines through a registry or other system that prioritized society's most vulnerable, many early doses were distributed through online registration systems run by pharmacies that priviliged people with high-speed internet access, advanced digital literacy, those with the time to spend days trying to book an online appointment (or social networks that could help with scheduling). A second barrier to access is tied to Allegheny County's history of residential segregation. Residents in many Black communities live in health care deserts, and lack easy access to health care practitioners or pharmacies. Most of the earliest public vaccination clinics organized by health systems, pharmacies, and local government agencies were not located in Black communities, and required registration and often relied on digital reservation systems.  
